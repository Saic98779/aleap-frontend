...
@Component({
  selector: 'app-view-program-dic',
  templateUrl: './view-program-dic.component.html',
  styleUrls: ['./view-program-dic.component.css']
})
export class ViewProgramDicComponent implements OnInit {
 ...
 onDateRangeChange() {
  ...
  //  },
   ...
   // modal.show();
     ...
     getAgenciesList() {
       this.agencyList = [];
       this._commonService.getDataByUrl(APIS.masterList.getDistricts).subscribe((res: any) => {
