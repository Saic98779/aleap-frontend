...
export const APIS = {
    ...
    masterList: {
        ...
        getStates: API_BASE_URL + '/states',
        getDistrictsByState: API_BASE_URL + '/districts/',
        getMandalsByDistrict: API_BASE_URL + '/mandals/',
    ...
    resource: {
        update: API_BASE_URL + '/resource/update/',
        delete: API_BASE_URL + '/resource/delete/'
    },
